...
//	pieceA->getVeterxGlobalCoords(vertexGlobalA, mating.firstPieceLocalCoords_);
//	b2Vec2 vertexGlobalB;
//	pieceB->getVeterxGlobalCoords(vertexGlobalB, mating.secondPieceLocalCoords_);
...
//				{
//					b2Vec2 vertexA;
//					pieceA.getVeterxGlobalCoords(vertexA, mating.firstPieceLocalCoords_);
//					b2Vec2 vertexB;
//					pieceA.getVeterxGlobalCoords(vertexB, mating.secondPieceLocalCoords_);
//
